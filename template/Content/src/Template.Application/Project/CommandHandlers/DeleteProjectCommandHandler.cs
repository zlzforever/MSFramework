...
{
	public class DeleteProjectCommandHandler : IRequestHandler<Commands.V10.DeleteProjectCommand, ObjectId>
	{
		...
		public async Task<ObjectId> HandleAsync(Commands.V10.DeleteProjectCommand command,
